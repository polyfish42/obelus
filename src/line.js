...
export default class Line {
  ...
  distanceFromStart() {
    if (this.onEdge.direction === N) {
      return Math.abs(this.endU - this.startVertex.u);
    } else {
      return Math.abs(this.endV - this.startVertex.v);
    }
  }

  distanceFromEnd() {
    if (this.onEdge.direction === N) {
      return Math.abs(this.endU - this.endVertex.u);
    } else {
      return Math.abs(this.endV - this.endVertex.v);
    }
  }
  ...
  update(du, dv) {
    ...
    let magnitude = this.capMagnitude(du, dv);
    let nextEdge;
